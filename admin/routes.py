...
FIXED: Corrected relationship references and imports.
"""
...
from sqlalchemy import func, desc  # Added desc import
...
def transaction_detail(transaction_id):
    ...
    user = account.user  # ✅ FIXED: Changed from 'owner' to 'user'
...
def make_deposit():
    ...
    form.account_id.choices = [
        (a.id, f'{a.account_number} - {a.user.username} - {a.account_name}')  # ✅ FIXED: Changed from 'owner' to 'user'
