...
class Account(db.Model):
    ...
    account_type = db.Column(db.String(20), nullable=False)  # savings, current, fixed_deposit
    ...
    def generate_account_number():
        ...
        while True:
            # Stanbic Bank Uganda accounts typically start with specific digits
    ...
    def update_balance(self, amount, transaction_type):
        ...
        Args:
            ...
            transaction_type: 'deposit', 'withdrawal', 'payment', 'transfer_in', 'transfer_out'
        """
