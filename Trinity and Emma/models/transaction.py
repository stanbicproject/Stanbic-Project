...
class Transaction(db.Model):
    ...
    transaction_type = db.Column(db.String(20), nullable=False)  # deposit, withdrawal, payment, transfer_in, transfer_out
    ...
    payment_method = db.Column(db.String(50), nullable=True)  # bank_transfer, mobile_money, utility
